...
ALTER TABLE "Orders" ALTER COLUMN "Phone" TYPE character varying(10);
ALTER TABLE "Orders" ALTER COLUMN "Phone" SET NOT NULL;
ALTER TABLE "Orders" ALTER COLUMN "Phone" SET DEFAULT '';

ALTER TABLE "Orders" ALTER COLUMN "Name" TYPE character varying(5);
ALTER TABLE "Orders" ALTER COLUMN "Name" SET NOT NULL;
ALTER TABLE "Orders" ALTER COLUMN "Name" SET DEFAULT '';
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20220413235131_UserAdded', '5.0.15');
